...
这是一个 KernelSU/Magisk systemless 字体模块，目标是实现 Noto Sans SC + Inter 混合字体：
...
- `dist/hybridfont_notosc_inter-v1.1.1.zip`
...
- 英文 Inter：正体 6 字重 + 斜体 6 字重。
- 中文 Noto Sans SC：7 字重。
...
- 完整包额外包含 `NotoSansCJK-Regular.ttc` 和 `NotoSansCJK-Bold.ttc` 兼容集合。
